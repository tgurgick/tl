...
function buildProjectInsights({ wsDir, specs = [], metrics = {}, experiments = [] }) {
  ...
  const linesAdded = wsDir ? countExperimentPatchLines(wsDir) : 0;
  ...
  return {
    ...
    lines_added: { experiments: linesAdded, total: linesAdded },
    tools,
    models,
